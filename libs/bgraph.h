...
extern pixel_t curcolor,charcolors[7];
extern const word *curfont;
extern pixel_t *writepos;
extern word writeposx;
...
static __inline pixel_t *getadr32(longint x,longint y)
  {
  return GetScreenAdr()+GetScreenPitch()*y+x;
  }

static __inline void point32(longint x,longint y, pixel_t color)
  {
  *getadr32(x,y)=color;
  }
